	...
	<title>Detail Transaksi</title>
                ...
                <div class="container-fluid">
                    ...
                    <?php foreach($sewa as $s){ ?>
                        <form class="user" action="<?php echo base_url() ?>c_karyawan/status?id=<?php echo $s['id_s'] ?>" enctype="multipart/form-data" method="post" name="submit">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="" id="collapseCardExample">
                                    <div class="card-body">
                                            ...
                                            <input type="text" class="form-control form-control-user" id="stok" name ="stok" value="<?php echo $s['stok']?>">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="collapse show" id="collapseCardExample4">
                                    <div class="card-body">
                                        <input type="hidden" class="form-control form-control-user" id="id_m" name="id_m" value="<?php echo $s['id_m']?>" >
                                            <div class="form-group">
                                                Nama:
                    ...
                    <?php 
                    if($s['status_s'] == "Menunggu Konfirmasi"){
                        echo "<input type='hidden' id='status_s' name ='status_s' value='Masa Sewa'>";
                        echo "<input class='btn btn-primary btn-user btn-block' id='submit' type='submit' name='submit' value='Konfirmasi Pembayaran'>";
                    }
                    else{
                        echo "<input type='hidden' id='status_s' name ='status_s' value='Selesai'>";
                        echo "<input class='btn btn-primary btn-user btn-block' id='submit' type='submit' name='submit' value='Dikembalikan'>";
                    }?>
